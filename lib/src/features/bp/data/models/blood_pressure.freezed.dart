...
mixin _$BloodPressure {
  ...
  DateTime get bpTime => throw _privateConstructorUsedError;
...
class _$BloodPressureCopyWithImpl<$Res, $Val extends BloodPressure>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      bpTime: null == bpTime
          ? _value.bpTime
          : bpTime // ignore: cast_nullable_to_non_nullable
              as DateTime,
    ) as $Val);
  }
}
...
class _$BloodPressureImpl implements _BloodPressure {
  ...
  @override
  String toString() {
    return 'BloodPressure(systolic: $systolic, diastolic: $diastolic, pulse_rate: $pulse_rate, notes: $notes, bpTime: $bpTime)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.bpTime, bpTime) || other.bpTime == bpTime));
  }

  @JsonKey(ignore: true)
  @override
  int get hashCode =>
      Object.hash(runtimeType, systolic, diastolic, pulse_rate, notes, bpTime);
...
abstract class _BloodPressure implements BloodPressure {
  const factory _BloodPressure(
      ...
      final String? notes,
      required final DateTime bpTime}) = _$BloodPressureImpl;
