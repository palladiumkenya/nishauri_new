...
import 'package:nishauri/src/features/period_planner/presentation/widgets/feature_tile.dart';
        ...
        data: (cycles) {
          ...
          if (!isNewUser) {
            ...
            if (isInPeriod) {
              ...
              message =
                  '$daysToNextPeriod day${daysToNextPeriod > 1 ? 's' : ''}';
              buttonText = 'Period Start';
              chances = 'Low';
                ...
                Align(
                  ...
                  child: Padding(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        context
                            .goNamed(RouteNames.PERIOD_PLANNER_PERIOD_HISTORY);
                      },
                      child: Text(
                        'Periods History',
            ...
            /*
            This is a scenario whereby either the user is a first time user 
            or the user has deleted all their cycles from their history
            */
            _periodStart = null;
            _periodEnd = null;
              ...
              children: [
                ...
                const Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(
                        "Let's kickstart your predictions.",
                        style: TextStyle(
                          fontWeight: FontWeight.bold,
                          fontSize: 20,
                        ),
                ...
                const SizedBox(height: Constants.SPACING + 30),
                Stack(
                  alignment: Alignment.center,
                  children: [
                    const SizedBox(
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        ElevatedButton(
                          onPressed: () {
                            context
                                .goNamed(RouteNames.PERIOD_PLANNER_LOG_PERIODS);
                          },
                          style: ElevatedButton.styleFrom(
                            foregroundColor: Colors.black,
                            backgroundColor: Constants.periodPlanner,
                  ...
                  child: Align(
                    ...
                    child: Padding(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () {
                          context.goNamed(
                              RouteNames.PERIOD_PLANNER_PERIOD_HISTORY);
                        },
                        child: Text(
                          'Periods History',
                          style: theme.textTheme.titleSmall?.copyWith(
