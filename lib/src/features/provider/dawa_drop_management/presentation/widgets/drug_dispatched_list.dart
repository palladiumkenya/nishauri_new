...
class DrugDispatchedList extends HookConsumerWidget {

  final List<DrugOrder> orders;

  const DrugDispatchedList({Key? key, required this.orders}) : super(key: key);
              ...
              itemBuilder: (context, index) {
                ...
                return RowViewList(
                  details: [
                    ...
                    {"icon": Icons.today, 'text': "Date order dispatched: ${DateFormat('dd-MM-yyyy').format(DateTime.parse(order.dispatched_date ?? ''))}"},
