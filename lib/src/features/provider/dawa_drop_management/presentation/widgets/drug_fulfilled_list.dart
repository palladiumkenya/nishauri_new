...
class DrugFulfilledList extends HookConsumerWidget {

  final List<DrugOrder> orders;

  const DrugFulfilledList({Key? key, required this.orders}) : super(key: key);
              ...
              itemBuilder: (context, index) {
                ...
                return RowViewList(
                  details: [
                    ...
                    {"icon": Icons.today, 'text': "Date order FulFilled: ${DateFormat('dd-MM-yyyy').format(DateTime.parse(order.fullfilled_date ?? ''))}"},
