...
class DrugApprovedRequestList extends HookConsumerWidget {

  final List<DrugOrder> orders;

  const DrugApprovedRequestList({Key? key, required this.orders}) : super(key: key);
              ...
              itemBuilder: (context, index) {
                ...
                return RowViewList(
                  details: [
                    ...
                    {"icon": Icons.today, 'text': "Date order approved: ${DateFormat('dd-MM-yyyy').format(DateTime.parse(order.approved_date ?? ''))}"},
                  ...
                  onRowTap: (index) {
                    HealthProgramDialog(
                      ...
                      "Dispatch the Drug order request bellow",
